...
import AdminReturnsGrid from '@/components/admin/returns/ReturnsGrid'
...
export default function AdminReturnHistoryPage() {
  ...
  return (
    <>
      <Box>
        ...
        >
          ...
          {filteredReturns.length === 0 ? (
            ...
            <>
              {isMobile ? (
                <AdminReturnsGrid returns={displayReturns} onViewOrder={handleOpenDetail} />
              ) : (
                <>
                  <ReturnTable returns={displayReturns} isAdmin={true} onViewOrderDetail={handleOpenDetail} />
                  <TablePagination
      ...
      {selectedOrderId && <ViewOrderModal open={detailOpen} onClose={handleCloseDetail} orderId={selectedOrderId} />}
    </>
  )
}
