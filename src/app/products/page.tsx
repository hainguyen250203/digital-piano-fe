...
import { useFetchProductFeatured, useFetchProductHotSale, useFetchProductList } from '@/hooks/apis/product'
...
function ProductsPageContent() {
  ...
  }, [filterParam, hotSaleProducts, hotSaleLoading, hotSaleError, featuredProducts, featuredLoading, featuredError, allProducts, allProductsLoading, allProductsError])
  ...
  return (
    <Box sx={{ py: 4 }}>
      ...
      <ProductList products={paginatedItems} error={error} isLoading={isLoading} />
